...
val headers_of_md :
  ...
  Representation.t ->
  (Representation.element * string * string) list
...
val html_and_headers_of_md :
  ...
  Representation.t ->
  string *
  (Representation.element * Utils.StringSet.elt * string) list
